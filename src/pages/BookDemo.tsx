  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: `Your ${callType} demo is scheduled for ${selectedDate} at ${selectedTime}.`,
      });
    }, 1500);
  };
            ...
            <ScrollAnimation animation="fade-in" className="max-w-4xl mx-auto">
              {!isBooked ? (
                    ...
                    <div className="md:w-1/3 p-6 md:p-8 bg-flux-800 text-white">
                      ...
                      <ul className="space-y-4">
                        <li className="flex items-start">
                          ...
                          <div>
                            <h3 className="font-semibold">20-Minute Demo</h3>
                ...
                <div className="bg-white rounded-xl shadow-md border border-gray-200 p-8 text-center">
                  ...
                  <h2 className="text-3xl font-bold mb-4">Your Demo is Scheduled!</h2>
                  <p className="text-xl text-gray-600 mb-2">Thank you for booking a discovery demo with us.</p>
                  <p className="text-gray-600 mb-6">
                    We've sent a calendar invitation to <strong>{email}</strong> for a {callType} demo on{' '}
                    <strong>{new Date(selectedDate).toLocaleDateString('en-GB', { weekday: 'long', month: 'long', day: 'numeric' })}</strong> at <strong>{selectedTime}</strong>.
                  </p>
                  ...
                  <div className="max-w-md mx-auto bg-gray-50 rounded-lg p-6 mb-8 border border-gray-200">
                    ...
                    <ol className="text-left space-y-2">
                      <li className="flex items-start">
                        ...
                        <span>You'll receive an email confirmation with demo details.</span>
                      </li>
                      <li className="flex items-start">
                        ...
                        <span>Our team will prepare for your demo based on the information provided.</span>
                      </li>
                      <li className="flex items-start">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="text-gray-600">
                      Yes, absolutely. The 20-minute discovery demo is completely free with no obligation to purchase.
                    </p>
                  </div>
                  <div>
